...
int main(int argv,char *arcg[])
{
	...
	while (curr_symb != EOF) {
		...
		//пишем вторую строку(слово из словарика) запись начнется при первом же русском символе в словарике, если знак препинания: игнорировать до русской буквы
		//сравниваем через while
